...
<main class="ml-[250px] w-[calc(100%-250px)] bg-dash-secondary min-h-screen font-worksans p-8">
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-gray-500">
            Daftar berita dan informasi yang telah dipublikasikan ke publik.
        </p>
    </div>
    ...
    <div class="bg-white p-4 rounded-xl border border-gray-200 mb-6 shadow-sm">
        <form action="#" method="GET" class="flex flex-wrap items-end gap-4 w-full">
            ...
            <div class="flex-1 min-w-[200px]">
                <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Cari Judul Berita</label>
                <div class="relative">
                    <input type="text" name="q" placeholder="Masukkan judul..."
            ...
            <div class="flex-1 min-w-[150px]">
                ...
                <select name="kategori" class="w-full h-10 px-3 bg-gray-50 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary focus:bg-white transition-all cursor-pointer">
            ...
            <div class="flex-1 min-w-[250px]">
                <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1.5">Rentang Waktu</label>
            ...
            <div class="flex items-center gap-2 mt-2 sm:mt-0">
                <a href="#" title="Reset Filter" class="h-10 px-4 flex items-center justify-center border border-gray-300 bg-white text-gray-600 text-sm font-bold rounded-lg hover:bg-gray-50 transition-colors shadow-sm">
                    Reset
                </a>
                <button type="submit" class="h-10 px-5 flex items-center justify-center bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary/90 transition-all shadow-sm gap-2">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
            ...
            <table class="w-full text-left border-collapse">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Tanggal Publikasi</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50/80 transition-colors">
                        <td class="px-6 py-4 text-sm font-bold text-neutral">Perbaikan Jalan Sudirman Tahap II Dimulai</td>
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-3">
                                <a href="#" class="text-gray-400 hover:text-primary transition-colors text-sm font-bold">Lihat</a>
                                <a href="#" class="text-primary hover:text-primary/80 transition-colors text-sm font-bold">Edit</a>
                            </div>
                        </td>
                    </tr>

                    <tr class="hover:bg-gray-50/80 transition-colors">
                        <td class="px-6 py-4 text-sm font-bold text-neutral">Peringatan Dini Keamanan Siber di Lingkungan Pemprov</td>
                        <td class="px-6 py-4 text-sm text-gray-500">Keamanan</td>
                        <td class="px-6 py-4 text-sm text-gray-500">10 Okt 2023</td>
                        <td class="px-6 py-4 text-sm text-gray-500">Admin Sistem</td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-bold border border-gray-200">
                                Archived
                            </span>
                        </td>
                        <td class="px-6 py-4 text-right">
                    ...
                    <tr class="hover:bg-gray-50/80 transition-colors">
                        <td class="px-6 py-4 text-sm font-bold text-neutral">Festival Budaya Tahunan 2023 Akan Digelar Minggu Depan</td>
                        <td class="px-6 py-4 text-sm text-gray-500">Event</td>
                        <td class="px-6 py-4 text-sm text-gray-500">08 Okt 2023</td>
                        <td class="px-6 py-4 text-sm text-gray-500">Dinas Pariwisata</td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 text-xs font-bold border border-emerald-100">
                                Published
                            </span>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50">
            <span class="text-xs font-semibold text-gray-500">Menampilkan 1 - 3 dari 42 berita</span>
            
            <div class="flex items-center gap-1.5">
                <button class="w-8 h-8 flex items-center justify-center border border-gray-300 bg-white text-gray-400 rounded-lg cursor-not-allowed">
